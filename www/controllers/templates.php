...
class Templates extends Base_Controller
{
    ...
    public function nodes_render(){
        echo'<div class="clearfix list-item" style="position:relative;">
            ...
            <div ui-tree-handle  style="margin:5px 0px;max-width:100%;padding-right:20px" class="pull-left tree-node tree-node-content list-body-content" ng-click="setTemporaryNode($event, node)">
