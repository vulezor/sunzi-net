...
class Templates extends Base_Controller
{
    ...
    public function nodes_render(){
        echo'<div class="clearfix list-item" style="position:relative;">
            ...
            <div ui-tree-handle  style="margin:5px 0px;" class="pull-left tree-node tree-node-content list-body-content" ng-click="setTemporaryNode($event, node)">
              ...
              <span data-ng-if="!node.edit" data-ng-dblclick="editPage($event, node)"> {{node.title}} </span> 
